#!/bin/bash
# check.sh - kontrollib õppija tegevusi Debian tarkvarahalduse ülesandes
...
# 3. Kontrolli, kas ajalugu on salvestatud
...
# 6. Kontrolli nginx versiooni olemasolu failis
...
# 7. Kontrolli, kas mc on eemaldatud
...
# 9. Kontrolli, kas webmin on paigaldatud
...
# 10. Kontrolli, kas webmin installifail on eemaldatud
